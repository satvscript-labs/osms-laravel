    ...
    @if ($isFirstRun)
        <div class="card card-lift border-0 shadow-sm rounded-4 mb-4 animate-fade-up bg-spotlight">
            <div class="card-body p-4">
                ...
                <p class="text-muted-foreground mb-4" style="font-size:var(--text-md);">Three quick steps to your first sale.</p>
                <div class="row g-3">
                    <div class="col-md-4">
                        <a href="{{ route('tenant.inventory.create') }}" class="d-block text-decoration-none card h-100 border rounded-4 p-3 card-lift">
                            ...
                            <p class="text-muted-foreground mb-0" style="font-size:var(--text-sm);">Stock your frames, lenses, and accessories.</p>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{ route('tenant.customers.create') }}" class="d-block text-decoration-none card h-100 border rounded-4 p-3 card-lift">
                            ...
                            <p class="text-muted-foreground mb-0" style="font-size:var(--text-sm);">Or add them on the fly while creating an order.</p>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{ route('tenant.orders.create') }}" class="d-block text-decoration-none card h-100 border rounded-4 p-3 card-lift">
                            ...
                            <p class="text-muted-foreground mb-0" style="font-size:var(--text-sm);">Ring up an order and print the receipt.</p>
                        </a>
                    </div>
                </div>
            </div>
